...
const Post = ({ post }: Props) => {
    ...
    return <main>
        ...
        <article className='max-w-3xl mx-auto p-5'>
            <h1 className='text-3xl mt-5 b-3'>{post.title}</h1>
    ...
    form-input mt-1 block w-full  ring-yellow-500 
    ...
    px-3 form-input mt-1 block w-full  ring-yellow-500 
    outline-none focus:ring'
                            placeholder='myemail@email.com' type="email" />
                    </label>
                    <label className='block mb-5'>
    ...
    outline-none focus:ring' rows={8} />
                    </label>
                    ...
                    <input type="submit" value="Submit" className='shadow bg-yellow-500 
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  body
    ...
    const post = await sanityClient.fetch(query, {
        slug: params?.slug,
        // ? is because params is initially undefined
    });
